...
const Features = () => {
  return (
    <div className='w-full h-1/3 flex justify-center items-center bg-[#002a3b] py-8'>
          ...
          <React.Fragment key={index}>
            <div className='flex justify-start items-center'>
              ...
              <div className='flex flex-col text-white justify-start items-start ml-6'>
                ...
                <h2 className='text-lg'>{feature.subtitle}</h2>
              </div>
            </div>
            {index < featuresData.length - 1 && <div className='h-12 w-[1px] bg-white hidden sm:block'></div>}
          </React.Fragment>
        ))}
      </div>
    </div>
